...
// 100% in normal operation (Eric runs his packs to a setting, not full).
...
// from Eric's Core 3 (ceiling 100): the LV MPPT held ~900-1060 W all day,
...
// based on Eric's setup (~16.8 kWp array, pool pump on a SHP2 circuit,
