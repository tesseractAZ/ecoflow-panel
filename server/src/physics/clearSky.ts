 ...
 *      roof-mounted array we approximate as horizontal (the operator's array is
...
/** Site & array constants for the operator's plant. Override at call site if
 ...
 * the sun. For the operator's setup near solar noon, this is within a few %
