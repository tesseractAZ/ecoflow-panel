 ...
 *
 * Eric's setup: 5 EcoFlow Delta Pro Ultra cores on the EcoFlow Cloud
 ...
 * without an SHP2. For Eric's setup (always has an SHP2 connected)
 * this isn't an issue.
 */
 ...
 *
 * For Eric's setup the SHP2 is always present, so this returns true
