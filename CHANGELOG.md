...
CV/absorption taper — Eric's LV string was fully shed at SoC 90. The
...
the "batteries full" threshold at 96% SoC — wrong for Eric's setup. The
...
The report ships with a hard-coded list of loads tuned for Eric's
